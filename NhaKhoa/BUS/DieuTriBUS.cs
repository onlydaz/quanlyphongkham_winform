...
namespace NhaKhoa.BUS
{
    public class DieuTriBUS
    {
        ...
        public List<Models.DieuTri> LayDanhSach()
        {
            return _dal.GetAll();
        }

        public List<Models.DieuTri> TimTheoTen(string ten)
        {
        ...
        public Models.DieuTri LayDieuTriTheoMa(string maDT)
        {
        ...
        public void ThemDieuTri(Models.DieuTri dt)
        {
        ...
        public void CapNhatDieuTri(Models.DieuTri dt)
        {
            if (string.IsNullOrWhiteSpace(dt.MaDT))
                throw new ArgumentException("Mã điều trị không được để trống");
